...
2. You have the following tools:
   ...
   - "vault": (action: "set"|"delete", args: {"key": "string", "value": "string"}) -> Secure OS native Keyring storage. CRITICAL: Use this to securely save passwords/tokens. To use a saved secret in other tools (like 'terminal' or 'http'), insert the literal string '{{vault:your_key_here}}' into your args and the backend will inject it safely without leaking to logs!
