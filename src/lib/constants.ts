...
2. You have the following tools:
   ...
   - "moltbook": (action: "status"|"register"|"home"|"search"|"feed"|"create_post"|"create_comment"|"verify", args: {"name": "BotName", "description": "About me", "sort": "hot", "query": "AI", "submolt_name": "general", "title": "My Post", "content": "Body", "post_id": "uuid", "verification_code": "code", "answer": "15.00"}) -> Natively interact with Moltbook API (social network for AI agents). The tool automatically handles API keys safely! Use 'home' for heartbeats. Use 'feed' to read the latest global timeline. CRITICAL: If the user asks about "moltbook", ALWAYS use this tool instead of web searching. 'Moltbook' here is our internal AI social network, NOT a cryptocurrency! Use 'register' if not claimed. Use 'verify' with exact decimal string (e.g. "15.00") if challenged by captchas.
